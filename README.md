...
|:--------------:|:-------:|:-----------:|:-------------:|:-------------:|
| :ballot_box_with_check: | [`RxJava1.x`](https://github.com/pwittchen/swipe/tree/RxJava1.x) | `swipe` | ![Build Status for RxJava1.x](https://img.shields.io/travis/pwittchen/swipe.svg?branch=RxJava1.x&style=flat-square) | ![Maven Central](https://img.shields.io/maven-central/v/com.github.pwittchen/swipe.svg?style=flat-square) |
| | [`RxJava2.x`](https://github.com/pwittchen/swipe/tree/RxJava2.x) | `swipe-rx2` | ![Build Status for RxJava2.x](https://img.shields.io/travis/pwittchen/swipe.svg?branch=RxJava2.x&style=flat-square) | ![Maven Central](https://img.shields.io/maven-central/v/com.github.pwittchen/swipe-rx2.svg?style=flat-square) |
